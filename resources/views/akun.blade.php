    ...
    <div class="my-2 px-8 pt-6 pb-4 shadow w-full h-full overflow-y-scroll">
        ...
        <table class="border w-full">
            ...
            <tr>
                ...
                <td>:{{ auth()->user()->nomor_identitas }} </td>
            ...
            <tr class="bg-slate-200">
                ...
                <td>:{{ auth()->user()->dataprovinsi->nama }} </td>
        ...
        <div class="mt-8 flex justify-end">
            <div class="flex gap-4 w-1/3">
                <a href="{{ route('account_edit') }}" class="w-1/2 bg-admin-secondary hover:opacity-90 py-1 rounded-full text-white text-center">Edit</a>
