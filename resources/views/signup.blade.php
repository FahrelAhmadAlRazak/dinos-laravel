            ...
            <form method="post" action="{{ route('signup') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="">
                        ...
                        <input type="text" class="form-control @error('nomor_identitas') is-invalid @enderror" id="nomor_identitas" name="nomor_identitas" placeholder="Nomor Identitas Penduduk">
                        {{-- @error('username')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror --}}
                    ...
                    <div class="">
                        ...
                        <input type="text" class="form-control @error('no_telpon') is-invalid @enderror" id="no_telpon" name="no_telpon" placeholder="Nomor Telpon">
                        {{-- @error('no_telpon')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror --}}
                    ...
                    <div class="">
                        ...
                        <div class="form-group" style="display: flex; align-items: center; gap: 10px; padding-top: 14px;">
                            <label for="exampleFormControlSelect2">Daftar sebagai</label>
                            <select class="form-control w-50" name="role" id="role">
